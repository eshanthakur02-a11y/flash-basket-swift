...
import { loadProductSubcategories, saveProductSubcategories, anyCategoryHasSubcategories } from "@/lib/productSubcategories";
...
function EditDialog({
  ...
  async function save() {
    ...
    if (subcategoryIds.length === 0 && await anyCategoryHasSubcategories(categoryIds)) {
